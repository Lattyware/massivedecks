...
Elm.MassiveDecks.Models = Elm.MassiveDecks.Models || {};
Elm.MassiveDecks.Models.Player = Elm.MassiveDecks.Models.Player || {};
Elm.MassiveDecks.Models.Player.make = function (_elm) {
   "use strict";
   _elm.MassiveDecks = _elm.MassiveDecks || {};
   _elm.MassiveDecks.Models = _elm.MassiveDecks.Models || {};
   _elm.MassiveDecks.Models.Player = _elm.MassiveDecks.Models.Player || {};
   if (_elm.MassiveDecks.Models.Player.values)
   return _elm.MassiveDecks.Models.Player.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var statusName = function (status) {
      ...
      {case "NotPlayed": return "not-played";
         ...
         case "Czar": return "czar";
         case "Disconnected": return "disconnected";
         case "Left": return "left";
         default: return "neutral";}
   };
   var Secret = F2(function (a,b) {    return {id: a,secret: b};});
   var Neutral = {ctor: "Neutral"};
   var Left = {ctor: "Left"};
   var Disconnected = {ctor: "Disconnected"};
   var Czar = {ctor: "Czar"};
   var Played = {ctor: "Played"};
   var NotPlayed = {ctor: "NotPlayed"};
   var nameToStatus = function (name) {
      var _p1 = name;
      switch (_p1)
      {case "not-played": return $Maybe.Just(NotPlayed);
         case "played": return $Maybe.Just(Played);
         case "czar": return $Maybe.Just(Czar);
         case "disconnected": return $Maybe.Just(Disconnected);
         case "left": return $Maybe.Just(Left);
         case "neutral": return $Maybe.Just(Neutral);
         default: return $Maybe.Nothing;}
   };
   var Player = F4(function (a,b,c,d) {
      return {id: a,name: b,status: c,score: d};
   });
   return _elm.MassiveDecks.Models.Player.values = {_op: _op
                                                   ,Player: Player
                                                   ,NotPlayed: NotPlayed
                                                   ,Played: Played
                                                   ,Czar: Czar
                                                   ...
                                                   ,nameToStatus: nameToStatus};
};
Elm.MassiveDecks = Elm.MassiveDecks || {};
Elm.MassiveDecks.Models = Elm.MassiveDecks.Models || {};
Elm.MassiveDecks.Models.Card = Elm.MassiveDecks.Models.Card || {};
Elm.MassiveDecks.Models.Card.make = function (_elm) {
   "use strict";
   _elm.MassiveDecks = _elm.MassiveDecks || {};
   _elm.MassiveDecks.Models = _elm.MassiveDecks.Models || {};
   _elm.MassiveDecks.Models.Card = _elm.MassiveDecks.Models.Card || {};
   if (_elm.MassiveDecks.Models.Card.values)
   return _elm.MassiveDecks.Models.Card.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var Hand = function (a) {    return {hand: a};};
   var Revealed = function (a) {
      return {ctor: "Revealed",_0: a};
   };
   var Hidden = function (a) {    return {ctor: "Hidden",_0: a};};
   var slots = function (call) {
      return $List.length(call) - 1;
   };
   return _elm.MassiveDecks.Models.Card.values = {_op: _op
                                                 ,slots: slots
                                                 ,Hidden: Hidden
                                                 ,Revealed: Revealed
                                                 ,Hand: Hand};
...
Elm.MassiveDecks = Elm.MassiveDecks || {};
Elm.MassiveDecks.Models = Elm.MassiveDecks.Models || {};
Elm.MassiveDecks.Models.Game = Elm.MassiveDecks.Models.Game || {};
Elm.MassiveDecks.Models.Game.make = function (_elm) {
   "use strict";
   _elm.MassiveDecks = _elm.MassiveDecks || {};
   _elm.MassiveDecks.Models = _elm.MassiveDecks.Models || {};
   _elm.MassiveDecks.Models.Game = _elm.MassiveDecks.Models.Game || {};
   if (_elm.MassiveDecks.Models.Game.values)
   return _elm.MassiveDecks.Models.Game.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   $MassiveDecks$Models$Card = Elm.MassiveDecks.Models.Card.make(_elm),
   $MassiveDecks$Models$Player = Elm.MassiveDecks.Models.Player.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var LobbyAndHand = F2(function (a,b) {
      return {lobby: a,hand: b};
   });
   var Lobby = F4(function (a,b,c,d) {
      return {id: a,config: b,players: c,round: d};
   });
   var Round = F3(function (a,b,c) {
      return {czar: a,call: b,responses: c};
   });
   var Config = function (a) {    return {deckIds: a};};
   return _elm.MassiveDecks.Models.Game.values = {_op: _op
                                                 ,Config: Config
                                                 ,Round: Round
                                                 ,Lobby: Lobby
...
Elm.MassiveDecks = Elm.MassiveDecks || {};
Elm.MassiveDecks.Actions = Elm.MassiveDecks.Actions || {};
Elm.MassiveDecks.Actions.Action = Elm.MassiveDecks.Actions.Action || {};
Elm.MassiveDecks.Actions.Action.make = function (_elm) {
   "use strict";
   _elm.MassiveDecks = _elm.MassiveDecks || {};
   _elm.MassiveDecks.Actions = _elm.MassiveDecks.Actions || {};
   _elm.MassiveDecks.Actions.Action = _elm.MassiveDecks.Actions.Action || {};
   if (_elm.MassiveDecks.Actions.Action.values)
   return _elm.MassiveDecks.Actions.Action.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   $MassiveDecks$Models$Game = Elm.MassiveDecks.Models.Game.make(_elm),
   $MassiveDecks$Models$Player = Elm.MassiveDecks.Models.Player.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var Choose = F2(function (a,b) {
      return {ctor: "Choose",_0: a,_1: b};
   });
   var Notification = function (a) {
      return {ctor: "Notification",_0: a};
   };
   var Withdraw = function (a) {
   ...
   var AddDeck = function (a) {
      return {ctor: "AddDeck",_0: a};
   };
   var JoinLobby = F3(function (a,b,c) {
      return {ctor: "JoinLobby",_0: a,_1: b,_2: c};
   });
   var JoinExistingLobby = {ctor: "JoinExistingLobby"};
   var NewLobby = function (a) {
      return {ctor: "NewLobby",_0: a};
   };
   var UpdateInputValue = F2(function (a,b) {
      return {ctor: "UpdateInputValue",_0: a,_1: b};
   });
   ...
   return _elm.MassiveDecks.Actions.Action.values = {_op: _op
                                                    ,Request: Request
                                                    ,Result: Result
                                                    ,NoAction: NoAction
                                                    ...
                                                    ,NewLobby: NewLobby
                                                    ,JoinExistingLobby: JoinExistingLobby
                                                    ,JoinLobby: JoinLobby
                                                    ,AddDeck: AddDeck
                                                    ,StartGame: StartGame
                                                    ,Pick: Pick
...
Elm.MassiveDecks = Elm.MassiveDecks || {};
Elm.MassiveDecks.Models = Elm.MassiveDecks.Models || {};
Elm.MassiveDecks.Models.Json = Elm.MassiveDecks.Models.Json || {};
Elm.MassiveDecks.Models.Json.Encode = Elm.MassiveDecks.Models.Json.Encode || {};
Elm.MassiveDecks.Models.Json.Encode.make = function (_elm) {
   "use strict";
   _elm.MassiveDecks = _elm.MassiveDecks || {};
   _elm.MassiveDecks.Models = _elm.MassiveDecks.Models || {};
   _elm.MassiveDecks.Models.Json = _elm.MassiveDecks.Models.Json || {};
   _elm.MassiveDecks.Models.Json.Encode = _elm.MassiveDecks.Models.Json.Encode || {};
   if (_elm.MassiveDecks.Models.Json.Encode.values)
   return _elm.MassiveDecks.Models.Json.Encode.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Json$Encode = Elm.Json.Encode.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var playerIdEncoder = function (playerId) {
      return $Json$Encode.$int(playerId);
   };
   var playerSecretEncoder = function (playerSecret) {
      return $Json$Encode.object(_U.list([{ctor: "_Tuple2"
                                          ,_0: "id"
                                          ,_1: playerIdEncoder(playerSecret.id)}
                                         ,{ctor: "_Tuple2"
                                          ,_0: "secret"
                                          ,_1: $Json$Encode.string(playerSecret.secret)}]));
   };
   var deckIdEncoder = function (id) {
      return {ctor: "_Tuple2"
             ,_0: "deckId"
             ,_1: $Json$Encode.string(id)};
   };
   var commandEncoder = F3(function (action,playerSecret,rest) {
      return A2($Json$Encode.encode,
      0,
      $Json$Encode.object($List.concat(_U.list([_U.list([{ctor: "_Tuple2"
                                                         ,_0: "command"
                                                         ,_1: $Json$Encode.string(action)}
                                                        ,{ctor: "_Tuple2"
                                                         ,_0: "secret"
                                                         ,_1: playerSecretEncoder(playerSecret)}])
                                               ,rest]))));
   });
   return _elm.MassiveDecks.Models.Json.Encode.values = {_op: _op
                                                        ,commandEncoder: commandEncoder
                                                        ,deckIdEncoder: deckIdEncoder
                                                        ,playerSecretEncoder: playerSecretEncoder
                                                        ,playerIdEncoder: playerIdEncoder};
};
Elm.MassiveDecks = Elm.MassiveDecks || {};
Elm.MassiveDecks.Models = Elm.MassiveDecks.Models || {};
Elm.MassiveDecks.Models.Json = Elm.MassiveDecks.Models.Json || {};
Elm.MassiveDecks.Models.Json.Decode = Elm.MassiveDecks.Models.Json.Decode || {};
Elm.MassiveDecks.Models.Json.Decode.make = function (_elm) {
   "use strict";
   _elm.MassiveDecks = _elm.MassiveDecks || {};
   _elm.MassiveDecks.Models = _elm.MassiveDecks.Models || {};
   _elm.MassiveDecks.Models.Json = _elm.MassiveDecks.Models.Json || {};
   _elm.MassiveDecks.Models.Json.Decode = _elm.MassiveDecks.Models.Json.Decode || {};
   if (_elm.MassiveDecks.Models.Json.Decode.values)
   return _elm.MassiveDecks.Models.Json.Decode.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var playerIdDecoder = $Json$Decode.$int;
   var playerSecretDecoder = A3($Json$Decode.object2,
   $MassiveDecks$Models$Player.Secret,
   A2($Json$Decode._op[":="],"id",playerIdDecoder),
   A2($Json$Decode._op[":="],"secret",$Json$Decode.string));
   var responseDecoder = $Json$Decode.string;
   var callDecoder = $Json$Decode.list($Json$Decode.string);
   var ResponsesTransport = F2(function (a,b) {
      return {count: a,cards: b};
   });
   var responsesTransportDecoder = A3($Json$Decode.object2,
   ResponsesTransport,
   ...
   $Json$Decode.maybe(A2($Json$Decode._op[":="],
   "cards",
   $Json$Decode.list($Json$Decode.list(responseDecoder)))));
   var responsesDecoder = A2($Json$Decode.customDecoder,
   responsesTransportDecoder,
   function (transport) {
      var _p0 = transport.count;
      if (_p0.ctor === "Just") {
            var _p1 = transport.cards;
            if (_p1.ctor === "Just") {
                  return $Result.Err("Got both count and cards.");
               } else {
                  return $Result.Ok($MassiveDecks$Models$Card.Hidden(_p0._0));
               }
         } else {
            var _p2 = transport.cards;
            if (_p2.ctor === "Just") {
                  return $Result.Ok($MassiveDecks$Models$Card.Revealed(_p2._0));
               } else {
                  return $Result.Err("Got neither count nor cards.");
               }
         }
   });
   var roundDecoder = A4($Json$Decode.object3,
   $MassiveDecks$Models$Game.Round,
   A2($Json$Decode._op[":="],"czar",playerIdDecoder),
   A2($Json$Decode._op[":="],"call",callDecoder),
   A2($Json$Decode._op[":="],"responses",responsesDecoder));
   var playerStatusDecoder = A2($Json$Decode.customDecoder,
   $Json$Decode.string,
   function (name) {
      return $Result.Ok(A2($Maybe.withDefault,
      $MassiveDecks$Models$Player.NotPlayed,
      $MassiveDecks$Models$Player.nameToStatus(name)));
   });
   var playerDecoder = A5($Json$Decode.object4,
   $MassiveDecks$Models$Player.Player,
   A2($Json$Decode._op[":="],"id",playerIdDecoder),
   A2($Json$Decode._op[":="],"name",$Json$Decode.string),
   A2($Json$Decode._op[":="],"status",playerStatusDecoder),
   A2($Json$Decode._op[":="],"score",$Json$Decode.$int));
   var handDecoder = A2($Json$Decode.object1,
   $MassiveDecks$Models$Card.Hand,
   A2($Json$Decode._op[":="],
   "hand",
   $Json$Decode.list(responseDecoder)));
   var configDecoder = A2($Json$Decode.object1,
   $MassiveDecks$Models$Game.Config,
   A2($Json$Decode._op[":="],
   "deckIds",
   $Json$Decode.list($Json$Decode.string)));
   var lobbyDecoder = A5($Json$Decode.object4,
   $MassiveDecks$Models$Game.Lobby,
   A2($Json$Decode._op[":="],"id",$Json$Decode.string),
   A2($Json$Decode._op[":="],"config",configDecoder),
   A2($Json$Decode._op[":="],
   "players",
   ...
   "round",
   roundDecoder)));
   var lobbyAndHandDecoder = A3($Json$Decode.object2,
   $MassiveDecks$Models$Game.LobbyAndHand,
   A2($Json$Decode._op[":="],"lobby",lobbyDecoder),
   A2($Json$Decode._op[":="],"hand",handDecoder));
   return _elm.MassiveDecks.Models.Json.Decode.values = {_op: _op
                                                        ,lobbyAndHandDecoder: lobbyAndHandDecoder
                                                        ,lobbyDecoder: lobbyDecoder
                                                        ,configDecoder: configDecoder
                                                        ,handDecoder: handDecoder
                                                        ,playerDecoder: playerDecoder
                                                        ,playerStatusDecoder: playerStatusDecoder
                                                        ,roundDecoder: roundDecoder
                                                        ,responsesDecoder: responsesDecoder
                                                        ,responsesTransportDecoder: responsesTransportDecoder
                                                        ,ResponsesTransport: ResponsesTransport
                                                        ,callDecoder: callDecoder
                                                        ,responseDecoder: responseDecoder
                                                        ,playerIdDecoder: playerIdDecoder
                                                        ,playerSecretDecoder: playerSecretDecoder};
};
Elm.MassiveDecks = Elm.MassiveDecks || {};
Elm.MassiveDecks.API = Elm.MassiveDecks.API || {};
Elm.MassiveDecks.API.make = function (_elm) {
   "use strict";
   _elm.MassiveDecks = _elm.MassiveDecks || {};
   _elm.MassiveDecks.API = _elm.MassiveDecks.API || {};
   if (_elm.MassiveDecks.API.values)
   return _elm.MassiveDecks.API.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $Json$Encode = Elm.Json.Encode.make(_elm),
   $List = Elm.List.make(_elm),
   $MassiveDecks$Actions$Action = Elm.MassiveDecks.Actions.Action.make(_elm),
   $MassiveDecks$Models$Game = Elm.MassiveDecks.Models.Game.make(_elm),
   $MassiveDecks$Models$Json$Decode = Elm.MassiveDecks.Models.Json.Decode.make(_elm),
   $MassiveDecks$Models$Json$Encode = Elm.MassiveDecks.Models.Json.Encode.make(_elm),
   $MassiveDecks$Models$Player = Elm.MassiveDecks.Models.Player.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   ...
   var handleError = function (error) {
      return $Task.succeed($MassiveDecks$Actions$Action.DisplayError($Basics.toString(error)));
   };
   var toEffect = function (task) {
      return $Effects.task(A2($Task.onError,task,handleError));
   };
   var lobbyAction = F2(function (lobbyId,content) {
      return A2($Http.fromJson,
      $MassiveDecks$Models$Json$Decode.lobbyAndHandDecoder,
      A2($Http.send,
      ...
      ,headers: _U.list([{ctor: "_Tuple2"
                         ...
                         ,_1: "application/json"}])
      ,url: A2($Http.url,
      A2($Basics._op["++"],"/lobbies/",lobbyId),
      _U.list([]))
      ,body: $Http.string(content)}));
   });
   var getLobbyAndHand = F2(function (lobbyId,secret) {
      return A2(lobbyAction,
      lobbyId,
      A3($MassiveDecks$Models$Json$Encode.commandEncoder,
      "getLobbyAndHand",
      secret,
      _U.list([])));
   });
   var choose = F3(function (lobbyId,secret,winner) {
      return A2(lobbyAction,
      lobbyId,
      A3($MassiveDecks$Models$Json$Encode.commandEncoder,
      "choose",
      ...
      _U.list([{ctor: "_Tuple2"
               ,_0: "winner"
               ,_1: $Json$Encode.$int(winner)}])));
   });
   var play = F3(function (lobbyId,secret,ids) {
      return A2(lobbyAction,
      lobbyId,
      A3($MassiveDecks$Models$Json$Encode.commandEncoder,
      "play",
   ...
   var newGame = F2(function (lobbyId,secret) {
      return A2(lobbyAction,
      lobbyId,
      A3($MassiveDecks$Models$Json$Encode.commandEncoder,
      "newGame",
   ...
   var addDeck = F3(function (lobbyId,secret,deckId) {
      return A2(lobbyAction,
      lobbyId,
      A3($MassiveDecks$Models$Json$Encode.commandEncoder,
      "addDeck",
      ...
      _U.list([{ctor: "_Tuple2"
               ,_0: "deckId"
               ,_1: $Json$Encode.string(deckId)}])));
   });
   var newPlayer = F2(function (lobbyId,name) {
      return A2($Http.fromJson,
      $MassiveDecks$Models$Json$Decode.playerSecretDecoder,
      A2($Http.send,
      $Http.defaultSettings,
      {verb: "POST"
      ,headers: _U.list([{ctor: "_Tuple2"
      ...
      A2($Basics._op["++"],
      "/lobbies/",
      A2($Basics._op["++"],lobbyId,"/players")),
      _U.list([]))
      ,body: $Http.string(A2($Basics._op["++"],
      "{ \"name\": \"",
      A2($Basics._op["++"],name,"\"}")))}));
   });
   var createLobby = A3($Http.post,
   $MassiveDecks$Models$Json$Decode.lobbyDecoder,
   A2($Http.url,"/lobbies",_U.list([])),
   $Http.empty);
   return _elm.MassiveDecks.API.values = {_op: _op
                                         ...
                                         ,play: play
                                         ,choose: choose
                                         ,getLobbyAndHand: getLobbyAndHand
...
Elm.MassiveDecks = Elm.MassiveDecks || {};
Elm.MassiveDecks.Models = Elm.MassiveDecks.Models || {};
Elm.MassiveDecks.Models.State = Elm.MassiveDecks.Models.State || {};
Elm.MassiveDecks.Models.State.make = function (_elm) {
   "use strict";
   _elm.MassiveDecks = _elm.MassiveDecks || {};
   _elm.MassiveDecks.Models = _elm.MassiveDecks.Models || {};
   _elm.MassiveDecks.Models.State = _elm.MassiveDecks.Models.State || {};
   if (_elm.MassiveDecks.Models.State.values)
   return _elm.MassiveDecks.Models.State.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var LobbyIdAndSecret = F2(function (a,b) {
      return {lobbyId: a,secret: b};
   });
   var PlayingData = F4(function (a,b,c,d) {
      return {lobby: a,hand: b,secret: c,picked: d};
   });
   var ConfigData = F3(function (a,b,c) {
      return {lobby: a,secret: b,deckId: c};
   });
   var StartData = F2(function (a,b) {
      return {name: a,lobbyId: b};
   });
   var SPlaying = function (a) {
      return {ctor: "SPlaying",_0: a};
   };
   var SConfig = function (a) {
      return {ctor: "SConfig",_0: a};
   };
   var SStart = function (a) {    return {ctor: "SStart",_0: a};};
   var Model = F3(function (a,b,c) {
      return {state: a,jsAction: b,error: c};
   });
   return _elm.MassiveDecks.Models.State.values = {_op: _op
                                                  ,Model: Model
                                                  ,SStart: SStart
                                                  ,SConfig: SConfig
                                                  ,SPlaying: SPlaying
                                                  ...
                                                  ,LobbyIdAndSecret: LobbyIdAndSecret};
};
Elm.MassiveDecks = Elm.MassiveDecks || {};
Elm.MassiveDecks.UI = Elm.MassiveDecks.UI || {};
Elm.MassiveDecks.UI.General = Elm.MassiveDecks.UI.General || {};
Elm.MassiveDecks.UI.General.make = function (_elm) {
   "use strict";
   _elm.MassiveDecks = _elm.MassiveDecks || {};
   _elm.MassiveDecks.UI = _elm.MassiveDecks.UI || {};
   _elm.MassiveDecks.UI.General = _elm.MassiveDecks.UI.General || {};
   if (_elm.MassiveDecks.UI.General.values)
   return _elm.MassiveDecks.UI.General.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var aboutOverlay = A2($Html.div,
   _U.list([$Html$Attributes.id("about")]),
   _U.list([A2($Html.div,
   _U.list([$Html$Attributes.$class("mui-panel")]),
   _U.list([A2($Html.p,
           _U.list([]),
           _U.list([$Html.text("Massive Decks is a clone of the excellent ")
                   ,A2($Html.a,
                   _U.list([$Html$Attributes.href("https://cardsagainsthumanity.com/")
                           ,$Html$Attributes.target("_blank")]),
                   _U.list([$Html.text("Cards against Humanity")]))
                   ,$Html.text(" using the ")
                   ,A2($Html.a,
                   _U.list([$Html$Attributes.href("https://www.cardcastgame.com/")
                           ,$Html$Attributes.target("_blank")]),
                   _U.list([$Html.text("CardCast")]))
                   ,$Html.text(" APIs (try their app if you have a ChromeCast!) and is inspired by ")
                   ,A2($Html.a,
                   _U.list([$Html$Attributes.href("http://pretendyoure.xyz/zy/")
                           ,$Html$Attributes.target("_blank")]),
                   _U.list([$Html.text("Pretend You\'re Xyzzy")]))
                   ,$Html.text(" (where you should go if you want to play with people you don\'t know).")]))
           ,A2($Html.p,
           _U.list([]),
           _U.list([$Html.text("This is an open source game developed in ")
                   ,A2($Html.a,
                   _U.list([$Html$Attributes.href("http://elm-lang.org/")
                           ,$Html$Attributes.target("_blank")]),
                   _U.list([$Html.text("Elm")]))
                   ,$Html.text(" for the client and ")
                   ,A2($Html.a,
                   _U.list([$Html$Attributes.href("http://www.scala-lang.org/")
                           ,$Html$Attributes.target("_blank")]),
                   _U.list([$Html.text("Scala")]))
                   ,$Html.text(" for the server. We also use ")
                   ,A2($Html.a,
                   _U.list([$Html$Attributes.href("https://www.playframework.com/")
                           ,$Html$Attributes.target("_blank")]),
                   _U.list([$Html.text("the Play framework")]))
                   ,$Html.text(", ")
                   ,A2($Html.a,
                   _U.list([$Html$Attributes.href("http://lesscss.org/")
                           ,$Html$Attributes.target("_blank")]),
                   _U.list([$Html.text("less")]))
                   ,$Html.text(", and ")
                   ,A2($Html.a,
                   _U.list([$Html$Attributes.href("https://fortawesome.github.io/Font-Awesome/")
                           ,$Html$Attributes.target("_blank")]),
                   _U.list([$Html.text("Font Awesome")]))
                   ,$Html.text(". Bug reports and contributions are welcome on our ")
                   ,A2($Html.a,
                   _U.list([$Html$Attributes.href("https://github.com/Lattyware/massivedecks")
                           ,$Html$Attributes.target("_blank")]),
                   _U.list([$Html.text("GitHub repository")]))
                   ,$Html.text(".")]))]))]));
   var lobbyUrl = function (lobbyId) {
      return A2($Basics._op["++"],"http://example.com/#",lobbyId);
   };
   var inviteOverlay = function (lobbyId) {
      var url = lobbyUrl(lobbyId);
      return A2($Html.div,
      _U.list([$Html$Attributes.id("invite")]),
      _U.list([A2($Html.div,
      _U.list([$Html$Attributes.$class("mui-panel")]),
      _U.list([A2($Html.p,
              _U.list([]),
              _U.list([$Html.text("To invite other players, simply send them this link: ")]))
              ,A2($Html.p,
              _U.list([]),
              _U.list([A2($Html.a,
              ...
              ,A2($Html.p,
              _U.list([]),
              _U.list([$Html.text("Or give them this game code to enter on the start page: ")]))
              ,A2($Html.p,
              _U.list([]),
              _U.list([A2($Html.input,
              _U.list([$Html$Attributes.readonly(true)
                      ,$Html$Attributes.value(lobbyId)]),
              _U.list([]))]))]))]));
   };
   var root = function (contents) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("content")]),
      contents);
   };
   var divider = A2($Html.div,
   _U.list([$Html$Attributes.$class("mui-divider")]),
   _U.list([]));
   ...
   var errorMessage = function (message) {
      ...
      if (_p0.ctor === "Just") {
            ...
            _U.list([$Html$Attributes.id("error")]),
            _U.list([icon("exclamation-triangle")
                    ,$Html.text(" Error")
                    ,divider
                    ,A2($Html.p,_U.list([]),_U.list([$Html.text(_p0._0)]))]))]);
         } else {
            return _U.list([]);
         }
   };
   var gameMenu = A2($Html.div,
   _U.list([$Html$Attributes.$class("menu mui-dropdown")]),
   _U.list([A2($Html.button,
           _U.list([$Html$Attributes.$class("mui-btn mui-btn--small mui-btn--primary")
                   ,A2($Html$Attributes.attribute,"data-mui-toggle","dropdown")]),
           _U.list([icon("ellipsis-h")]))
           ,A2($Html.ul,
           _U.list([$Html$Attributes.$class("mui-dropdown__menu mui-dropdown__menu--right")]),
           _U.list([A2($Html.li,
                   _U.list([]),
                   _U.list([A2($Html.a,
                   _U.list([$Html$Attributes.href("#")
                           ,A2($Html$Attributes.attribute,"onClick","inviteOverlay()")]),
                   _U.list([icon("bullhorn"),$Html.text(" Invite Players")]))]))
                   ,A2($Html.li,
                   _U.list([]),
                   _U.list([A2($Html.a,
                   _U.list([$Html$Attributes.href("#")]),
                   _U.list([icon("sign-out"),$Html.text(" Leave Game")]))]))
                   ,A2($Html.li,
                   _U.list([$Html$Attributes.$class("mui-divider")]),
                   _U.list([]))
                   ,A2($Html.li,
                   ...
                   _U.list([A2($Html.a,
                   _U.list([$Html$Attributes.href("#")
                           ,A2($Html$Attributes.attribute,"onClick","aboutOverlay()")]),
                   _U.list([icon("info-circle"),$Html.text(" About")]))]))
                   ,A2($Html.li,
                   _U.list([]),
                   _U.list([A2($Html.a,
                   _U.list([$Html$Attributes.href("https://github.com/Lattyware/massivedecks/issues/new")
                           ,$Html$Attributes.target("_blank")]),
                   _U.list([icon("bug"),$Html.text(" Report a bug")]))]))]))]));
   return _elm.MassiveDecks.UI.General.values = {_op: _op
                                                ,icon: icon
...
Elm.MassiveDecks = Elm.MassiveDecks || {};
Elm.MassiveDecks.UI = Elm.MassiveDecks.UI || {};
Elm.MassiveDecks.UI.Lobby = Elm.MassiveDecks.UI.Lobby || {};
Elm.MassiveDecks.UI.Lobby.make = function (_elm) {
   "use strict";
   _elm.MassiveDecks = _elm.MassiveDecks || {};
   _elm.MassiveDecks.UI = _elm.MassiveDecks.UI || {};
   _elm.MassiveDecks.UI.Lobby = _elm.MassiveDecks.UI.Lobby || {};
   if (_elm.MassiveDecks.UI.Lobby.values)
   return _elm.MassiveDecks.UI.Lobby.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $List = Elm.List.make(_elm),
   $MassiveDecks$Models$Player = Elm.MassiveDecks.Models.Player.make(_elm),
   $MassiveDecks$UI$General = Elm.MassiveDecks.UI.General.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var statusIcon = function (status) {
      ...
      switch (_p0.ctor)
      {case "NotPlayed":
         return $MassiveDecks$UI$General.icon("hourglass");
         case "Played": return $MassiveDecks$UI$General.icon("check");
         case "Czar": return $MassiveDecks$UI$General.icon("gavel");
         case "Disconnected":
         return $MassiveDecks$UI$General.icon("minus-circle");
         case "Left": return $MassiveDecks$UI$General.icon("sign-out");
         default: return $Html.text("");}
   };
   var statusDescription = function (status) {
      var _p1 = status;
      switch (_p1.ctor)
      {case "NotPlayed": return "Choosing";
         case "Played": return "Played";
         case "Czar": return "Round Czar";
         case "Disconnected": return "Disconnected";
         case "Left": return "Left Game";
         default: return "";}
   };
   var appHeader = function (contents) {
      return A2($Html.header,
      _U.list([]),
      _U.list([A2($Html.div,
      _U.list([$Html$Attributes.$class("mui-appbar mui--appbar-line-height")]),
      _U.list([A2($Html.div,
      _U.list([$Html$Attributes.$class("mui--appbar-line-height")]),
      _U.list([A2($Html.button,
              _U.list([$Html$Attributes.$class("scores-toggle mui-btn mui-btn--small mui-btn--primary mui--visible-xs-inline-block js-show-scores")]),
              _U.list([$MassiveDecks$UI$General.icon("users")]))
              ,A2($Html.button,
              _U.list([$Html$Attributes.$class("scores-toggle mui-btn mui-btn--small mui-btn--primary mui--hidden-xs js-hide-scores")]),
              _U.list([$MassiveDecks$UI$General.icon("users")]))
              ,A2($Html.span,
              _U.list([$Html$Attributes.id("title")
                      ,$Html$Attributes.$class("mui--text-title mui--visible-xs-inline-block")]),
              contents)
              ,$MassiveDecks$UI$General.gameMenu]))]))]));
   };
   var score = function (player) {
      return A2($Html.tr,
      _U.list([$Html$Attributes.$class($MassiveDecks$Models$Player.statusName(player.status))
              ,$Html$Attributes.title(statusDescription(player.status))]),
      _U.list([A2($Html.td,
              _U.list([$Html$Attributes.$class("state")]),
              _U.list([statusIcon(player.status)]))
              ,A2($Html.td,
              _U.list([$Html$Attributes.$class("name")]),
              _U.list([$Html.text(player.name)]))
              ,A2($Html.td,
              _U.list([$Html$Attributes.$class("score")]),
              _U.list([$Html.text($Basics.toString(player.score))]))]));
   };
   var scores = function (players) {
      return A2($Html.div,
      _U.list([$Html$Attributes.id("scores")]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.id("scores-title")
                      ,$Html$Attributes.$class("mui--appbar-line-height mui--text-title")]),
              _U.list([$Html.text("Scores")]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("mui-divider")]),
              _U.list([]))
              ,A2($Html.table,
              _U.list([$Html$Attributes.$class("mui-table")]),
              $List.concat(_U.list([_U.list([A2($Html.thead,
                                   _U.list([]),
                                   _U.list([A2($Html.tr,
                                   _U.list([]),
                                   _U.list([A2($Html.th,
                                           _U.list([$Html$Attributes.$class("state")
                                                   ,$Html$Attributes.title("State")]),
                                           _U.list([$MassiveDecks$UI$General.icon("tasks")]))
                                           ,A2($Html.th,
                                           _U.list([$Html$Attributes.$class("name")]),
                                           _U.list([$Html.text("Player")]))
                                           ,A2($Html.th,
                                           _U.list([$Html$Attributes.$class("score")
                                                   ,$Html$Attributes.title("Score")]),
                                           _U.list([$MassiveDecks$UI$General.icon("star")]))]))]))])
                                   ,A2($List.map,score,players)])))]));
   };
   var spacer = A2($Html.div,
   _U.list([$Html$Attributes.$class("mui--appbar-height")]),
   _U.list([]));
   var contentWrapper = function (contents) {
      return A2($Html.div,
      _U.list([$Html$Attributes.id("content-wrapper")]),
      contents);
   };
   var view = F4(function (lobbyId,header,players,contents) {
      return $MassiveDecks$UI$General.root(_U.list([appHeader(header)
                                                   ,spacer
                                                   ,scores(players)
                                                   ,contentWrapper(contents)
                                                   ,$MassiveDecks$UI$General.inviteOverlay(lobbyId)
                                                   ,$MassiveDecks$UI$General.aboutOverlay]));
   });
   return _elm.MassiveDecks.UI.Lobby.values = {_op: _op
                                              ,view: view
...
Elm.MassiveDecks = Elm.MassiveDecks || {};
Elm.MassiveDecks.UI = Elm.MassiveDecks.UI || {};
Elm.MassiveDecks.UI.Config = Elm.MassiveDecks.UI.Config || {};
Elm.MassiveDecks.UI.Config.make = function (_elm) {
   "use strict";
   _elm.MassiveDecks = _elm.MassiveDecks || {};
   _elm.MassiveDecks.UI = _elm.MassiveDecks.UI || {};
   _elm.MassiveDecks.UI.Config = _elm.MassiveDecks.UI.Config || {};
   if (_elm.MassiveDecks.UI.Config.values)
   return _elm.MassiveDecks.UI.Config.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $List = Elm.List.make(_elm),
   $MassiveDecks$Actions$Action = Elm.MassiveDecks.Actions.Action.make(_elm),
   $MassiveDecks$Models$State = Elm.MassiveDecks.Models.State.make(_elm),
   $MassiveDecks$UI$General = Elm.MassiveDecks.UI.General.make(_elm),
   $MassiveDecks$UI$Lobby = Elm.MassiveDecks.UI.Lobby.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var deckManagement = F2(function (address,deckIds) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.div,
              ...
              _U.list([A2($Html.input,
                      _U.list([$Html$Attributes.type$("text")
                              ,$Html$Attributes.placeholder("Deck Id")
                              ,A3($Html$Events.on,
                              "change",
                              ...
                              function (deckId) {
                                 ...
                                 address,
                                 A2($MassiveDecks$Actions$Action.UpdateInputValue,
                                 "deckId",
                                 deckId));
                              })
                              ...
                              function (key) {
                                 var _p0 = key;
                                 if (_p0 === 13) {
                                       return $MassiveDecks$Actions$Action.AddDeck($MassiveDecks$Actions$Action.Request);
                                    } else {
                                       return $MassiveDecks$Actions$Action.NoAction;
                                    }
                              })]),
                      _U.list([]))
                      ,A2($Html.label,
                      _U.list([]),
                      _U.list([$MassiveDecks$UI$General.icon("info-circle")
                              ,$Html.text(" A ")
                              ,A2($Html.a,
                              _U.list([$Html$Attributes.href("https://www.cardcastgame.com/browse")
                                      ,$Html$Attributes.target("_blank")]),
                              _U.list([$Html.text("CardCast")]))
                              ,$Html.text(" Deck Id")]))]))
              ,A2($Html.button,
              _U.list([$Html$Attributes.$class("mui-btn mui-btn--raised")
                      ,A2($Html$Events.onClick,
                      address,
                      $MassiveDecks$Actions$Action.AddDeck($MassiveDecks$Actions$Action.Request))]),
              _U.list([$Html.text("Add Deck")]))
              ,A2($Html.ul,
              _U.list([]),
              A2($List.map,
              function (deckId) {
              ...
              _U.list([$Html$Attributes.$class("mui-btn mui-btn--raised")
                      ,A2($Html$Events.onClick,
                      address,
                      $MassiveDecks$Actions$Action.StartGame($MassiveDecks$Actions$Action.Request))]),
              _U.list([$Html.text("Start Game")]))]));
   });
   var view = F3(function (address,data,error) {
      var lobby = data.lobby;
      var url = $MassiveDecks$UI$General.lobbyUrl(lobby.id);
      return A4($MassiveDecks$UI$Lobby.view,
      lobby.id,
      _U.list([]),
      lobby.players,
      $List.concat(_U.list([_U.list([A2($Html.div,
                           _U.list([$Html$Attributes.id("start-screen")]),
                           _U.list([A2($Html.div,
                           _U.list([$Html$Attributes.id("start-screen-content")]),
                           _U.list([A2($Html.p,
                                   _U.list([]),
                                   _U.list([$Html.text("Invite others to the game with the code \'")
                                           ,A2($Html.strong,
                                           _U.list([$Html$Attributes.$class("game-code")]),
                                           _U.list([$Html.text(lobby.id)]))
                                           ,$Html.text("\' to enter on the main page, or give them this link: ")]))
                                   ,A2($Html.p,
                                   _U.list([]),
                                   _U.list([A2($Html.a,
                                   _U.list([$Html$Attributes.href(url)]),
                                   _U.list([$Html.text(url)]))]))
                                   ,A2($Html.h1,_U.list([]),_U.list([$Html.text("Game Setup")]))
                                   ,A2(deckManagement,address,lobby.config.deckIds)]))]))])
                           ,$MassiveDecks$UI$General.errorMessage(error)])));
   });
   return _elm.MassiveDecks.UI.Config.values = {_op: _op
                                               ,view: view
                                               ,deckManagement: deckManagement};
};
Elm.MassiveDecks = Elm.MassiveDecks || {};
Elm.MassiveDecks.Util = Elm.MassiveDecks.Util || {};
Elm.MassiveDecks.Util.make = function (_elm) {
   "use strict";
   _elm.MassiveDecks = _elm.MassiveDecks || {};
   _elm.MassiveDecks.Util = _elm.MassiveDecks.Util || {};
   if (_elm.MassiveDecks.Util.values)
   return _elm.MassiveDecks.Util.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var interleave = F2(function (list1,list2) {
      ...
      if (_p0.ctor === "[]") {
            ...
            if (_p1.ctor === "[]") {
                  ...
                  return A2($List._op["::"],
                  _p1._0,
                  A2($List._op["::"],_p0._0,A2(interleave,_p0._1,_p1._1)));
               }
         }
   });
   return _elm.MassiveDecks.Util.values = {_op: _op
                                          ,interleave: interleave};
};
Elm.MassiveDecks = Elm.MassiveDecks || {};
Elm.MassiveDecks.UI = Elm.MassiveDecks.UI || {};
Elm.MassiveDecks.UI.Playing = Elm.MassiveDecks.UI.Playing || {};
Elm.MassiveDecks.UI.Playing.make = function (_elm) {
   "use strict";
   _elm.MassiveDecks = _elm.MassiveDecks || {};
   _elm.MassiveDecks.UI = _elm.MassiveDecks.UI || {};
   _elm.MassiveDecks.UI.Playing = _elm.MassiveDecks.UI.Playing || {};
   if (_elm.MassiveDecks.UI.Playing.values)
   return _elm.MassiveDecks.UI.Playing.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $MassiveDecks$UI$General = Elm.MassiveDecks.UI.General.make(_elm),
   $MassiveDecks$UI$Lobby = Elm.MassiveDecks.UI.Lobby.make(_elm),
   $MassiveDecks$Util = Elm.MassiveDecks.Util.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var chooseButton = F2(function (address,playedId) {
      return A2($Html.li,
      _U.list([$Html$Attributes.$class("choose-button")]),
      _U.list([A2($Html.button,
      _U.list([$Html$Attributes.$class("mui-btn mui-btn--small mui-btn--accent mui-btn--fab")
              ,A2($Html$Events.onClick,
              address,
              A2($MassiveDecks$Actions$Action.Choose,
              playedId,
              $MassiveDecks$Actions$Action.Request))]),
      _U.list([$MassiveDecks$UI$General.icon("trophy")]))]));
   });
   var playedResponse = function (contents) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("card response mui-panel")]),
      _U.list([A2($Html.div,
      _U.list([$Html$Attributes.$class("response-text")]),
      _U.list([$Html.text(contents)]))]));
   };
   var playedCards = F4(function (address,isCzar,playedId,cards) {
      var extra = isCzar ? _U.list([A2(chooseButton,
      address,
      playedId)]) : _U.list([]);
      return A2($Html.ol,
      _U.list([]),
      $List.concat(_U.list([A2($List.map,
                           function (card) {
                              return A2($Html.li,
                              _U.list([]),
                              _U.list([playedResponse(card)]));
                           },
                           cards)
                           ,extra])));
   });
   var playedView = F3(function (address,isCzar,cards) {
      return A2($Html.ol,
      _U.list([$Html$Attributes.$class("played")]),
      A2($List.indexedMap,
      F2(function (index,pc) {
         return A2($Html.li,
         _U.list([]),
         _U.list([A4(playedCards,address,isCzar,index,pc)]));
      }),
      cards));
   });
   var playButton = function (address) {
      return A2($Html.li,
      _U.list([$Html$Attributes.$class("play-button")]),
      _U.list([A2($Html.button,
      _U.list([$Html$Attributes.$class("mui-btn mui-btn--small mui-btn--accent mui-btn--fab")
              ,A2($Html$Events.onClick,
              address,
              $MassiveDecks$Actions$Action.Play($MassiveDecks$Actions$Action.Request))]),
      _U.list([$MassiveDecks$UI$General.icon("thumbs-up")]))]));
   };
   var pickedResponse = F2(function (address,_p0) {
      var _p1 = _p0;
      return A2($Html.li,
      _U.list([A2($Html$Events.onClick,
      address,
      $MassiveDecks$Actions$Action.Withdraw(_p1._0))]),
      _U.list([A2($Html.div,
      _U.list([$Html$Attributes.$class("card response mui-panel")]),
      _U.list([A2($Html.div,
      _U.list([$Html$Attributes.$class("response-text")]),
   ...
   var pickedView = F3(function (address,picked,slots) {
      var pb = _U.cmp($List.length(picked),
      slots) < 0 ? _U.list([]) : _U.list([playButton(address)]);
      return A2($Html.ol,
      _U.list([$Html$Attributes.$class("picked")]),
      $List.concat(_U.list([A2($List.map,
                           pickedResponse(address),
                           picked)
                           ,pb])));
   });
   var handRender = F2(function (isCzar,contents) {
      var classes = A2($Basics._op["++"],
      "hand mui--divider-top",
      isCzar ? " disabled" : "");
      return A2($Html.ul,
      _U.list([$Html$Attributes.$class(classes)]),
      A2($List.map,
      function (item) {
         return A2($Html.li,_U.list([]),_U.list([item]));
      },
      contents));
   });
   var response = F5(function (address,
   picked,
   isCzar,
   responseId,
   contents) {
      var isPicked = A2($List.member,responseId,picked);
      var pickedClass = isPicked ? " picked" : "";
      var classes = _U.list([$Html$Attributes.$class(A2($Basics._op["++"],
      "card response mui-panel",
      pickedClass))]);
      var clickHandler = isPicked || isCzar ? _U.list([]) : _U.list([A2($Html$Events.onClick,
      address,
      $MassiveDecks$Actions$Action.Pick(responseId))]);
      return A2($Html.div,
      $List.concat(_U.list([classes,clickHandler])),
      _U.list([A2($Html.div,
      _U.list([$Html$Attributes.$class("response-text")]),
      _U.list([$Html.text(contents)]))]));
   });
   var handView = F4(function (address,picked,isCzar,responses) {
      return A2(handRender,
      isCzar,
      A2($List.indexedMap,
      A3(response,address,picked,isCzar),
      responses));
   });
   var slot = function (value) {
      return A2($Html.span,
      _U.list([$Html$Attributes.$class("slot")]),
      _U.list([$Html.text(value)]));
   };
   var slots = F3(function (count,placeholder,picked) {
      var extra = count - $List.length(picked);
      return A2($List.map,
      slot,
      $List.concat(_U.list([picked
                           ,A2($List.repeat,extra,placeholder)])));
   });
   var call = F2(function (contents,picked) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("card call mui-panel")]),
      _U.list([A2($Html.div,
      _U.list([$Html$Attributes.$class("call-text ")]),
      A2($MassiveDecks$Util.interleave,
      A3(slots,$MassiveDecks$Models$Card.slots(contents),"",picked),
      A2($List.map,$Html.text,contents)))]));
   });
   var playArea = function (contents) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("play-area")]),
      contents);
   };
   var czarName = F2(function (players,czarId) {
      ...
      function (player) {
         return _U.eq(player.id,czarId);
      },
      players))));
   });
   var view = F3(function (address,error,data) {
      var hand = data.hand.hand;
      var lobby = data.lobby;
      var content = function () {
         var _p2 = lobby.round;
         if (_p2.ctor === "Just") {
               var _p4 = _p2._0;
               var isCzar = _U.eq(_p4.czar,data.secret.id);
               var pickedWithIndex = A2($List.filter,
               function (item) {
                  return A2($List.member,$Basics.fst(item),data.picked);
               },
               A2($List.indexedMap,
               F2(function (v0,v1) {
                  return {ctor: "_Tuple2",_0: v0,_1: v1};
               ...
               hand));
               var picked = A2($List.map,$Basics.snd,pickedWithIndex);
               var pickedOrPlayed = function () {
                  var _p3 = _p4.responses;
                  if (_p3.ctor === "Revealed") {
                        return A3(playedView,address,isCzar,_p3._0);
                     } else {
                        return A3(pickedView,
                        address,
                        pickedWithIndex,
                        $MassiveDecks$Models$Card.slots(_p4.call));
                     }
               }();
               return _U.list([playArea(_U.list([A2(call,_p4.call,picked)
                                                ,pickedOrPlayed]))
                              ,A4(handView,address,data.picked,isCzar,hand)]);
            } else {
               return _U.list([]);
            }
      }();
      var header = function () {
         var _p5 = lobby.round;
         if (_p5.ctor === "Just") {
               return _U.list([$MassiveDecks$UI$General.icon("gavel")
                              ,$Html.text(A2($Basics._op["++"],
                              " ",
                              A2(czarName,lobby.players,_p5._0.czar)))]);
            } else {
               return _U.list([]);
            }
      }();
      ...
      header,
      lobby.players,
      $List.concat(_U.list([content
                           ,$MassiveDecks$UI$General.errorMessage(error)])));
   });
   return _elm.MassiveDecks.UI.Playing.values = {_op: _op
                                                ,view: view
                                                ,czarName: czarName
                                                ,playArea: playArea
                                                ,call: call
                                                ...
                                                ,playedResponse: playedResponse
                                                ,chooseButton: chooseButton};
};
Elm.MassiveDecks = Elm.MassiveDecks || {};
Elm.MassiveDecks.Playing = Elm.MassiveDecks.Playing || {};
Elm.MassiveDecks.Playing.make = function (_elm) {
   "use strict";
   _elm.MassiveDecks = _elm.MassiveDecks || {};
   _elm.MassiveDecks.Playing = _elm.MassiveDecks.Playing || {};
   if (_elm.MassiveDecks.Playing.values)
   return _elm.MassiveDecks.Playing.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $Html = Elm.Html.make(_elm),
   $List = Elm.List.make(_elm),
   $MassiveDecks$API = Elm.MassiveDecks.API.make(_elm),
   $MassiveDecks$Actions$Action = Elm.MassiveDecks.Actions.Action.make(_elm),
   $MassiveDecks$Models$Card = Elm.MassiveDecks.Models.Card.make(_elm),
   $MassiveDecks$Models$Player = Elm.MassiveDecks.Models.Player.make(_elm),
   $MassiveDecks$Models$State = Elm.MassiveDecks.Models.State.make(_elm),
   $MassiveDecks$UI$Playing = Elm.MassiveDecks.UI.Playing.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var view = F3(function (address,error,playingData) {
      return A3($MassiveDecks$UI$Playing.view,
      address,
      error,
      playingData);
   });
   var configModel = F2(function (error,data) {
      return {state: $MassiveDecks$Models$State.SConfig(data)
             ,jsAction: $Maybe.Nothing
             ,error: error};
   });
   var modelSub = F4(function (error,lobbyId,secret,data) {
      return {state: $MassiveDecks$Models$State.SPlaying(data)
             ,jsAction: $Maybe.Just({lobbyId: lobbyId,secret: secret})
             ,error: error};
   });
   var model = F2(function (error,data) {
      return {state: $MassiveDecks$Models$State.SPlaying(data)
             ,jsAction: $Maybe.Nothing
             ,error: error};
   });
   var update = F3(function (action,error,data) {
      var _p0 = action;
      _v0_8: do {
         switch (_p0.ctor)
         {case "Pick": var playing = A2($Maybe.withDefault,
              false,
              A2($Maybe.map,
              function (round) {
                 var _p1 = round.responses;
                 if (_p1.ctor === "Revealed") {
                       return false;
                    } else {
                       return true;
                    }
              ...
              data.lobby.round));
              var canPlay = _U.cmp($List.length(data.picked),
              A2($Maybe.withDefault,
              0,
              A2($Maybe.map,
              function (round) {
                 return $MassiveDecks$Models$Card.slots(round.call);
              },
              data.lobby.round))) < 0;
              return playing && canPlay ? {ctor: "_Tuple2"
                                          ,_0: A2(model,
                                          error,
                                          _U.update(data,
                                          {picked: A2($List._op["::"],_p0._0,data.picked)}))
                                          ,_1: $Effects.none} : {ctor: "_Tuple2"
                                                                ,_0: A2(model,error,data)
                                                                ,_1: $Effects.none};
            case "Withdraw": return {ctor: "_Tuple2"
                                    ,_0: A2(model,
                                    error,
                                    _U.update(data,
                                    {picked: A2($List.filter,
                                    F2(function (x,y) {    return !_U.eq(x,y);})(_p0._0),
                                    data.picked)}))
                                    ,_1: $Effects.none};
            case "Play": if (_p0._0.ctor === "Request") {
                    return {ctor: "_Tuple2"
                           ,_0: A2(model,error,data)
                           ,_1: $MassiveDecks$API.toEffect(A2($Task.map,
                           function (_p2) {
                              return $MassiveDecks$Actions$Action.Play($MassiveDecks$Actions$Action.Result(_p2));
                           },
                           A3($MassiveDecks$API.play,
                           data.lobby.id,
                           data.secret,
                           data.picked)))};
                 } else {
                    ...
                    return {ctor: "_Tuple2"
                           ...
                           error,
                           _U.update(data,
                           {lobby: _p3.lobby,hand: _p3.hand,picked: _U.list([])}))
                           ,_1: $Effects.none};
                 }
            case "Notification": var _p5 = _p0._0;
              var _p4 = _p5.round;
              if (_p4.ctor === "Just") {
                    return {ctor: "_Tuple2"
                           ,_0: A2(model,error,_U.update(data,{lobby: _p5}))
                           ,_1: $Effects.none};
                 } else {
                    return {ctor: "_Tuple2"
                           ,_0: A2(configModel,
                           error,
                           A3($MassiveDecks$Models$State.ConfigData,_p5,data.secret,""))
                           ,_1: $Effects.none};
                 }
            case "JoinLobby": if (_p0._2.ctor === "Result") {
                    var _p7 = _p0._2._0;
                    var _p6 = _p7.lobby.round;
                    if (_p6.ctor === "Just") {
                          return {ctor: "_Tuple2"
                                 ,_0: A2(model,error,_U.update(data,{lobby: _p7.lobby}))
                                 ,_1: $Effects.none};
                       } else {
                          return {ctor: "_Tuple2"
                                 ,_0: A2(configModel,
                                 error,
                                 A3($MassiveDecks$Models$State.ConfigData,
                                 _p7.lobby,
                                 data.secret,
                                 ""))
                                 ,_1: $Effects.none};
            ...
            case "Choose": if (_p0._1.ctor === "Request") {
                    var _p9 = _p0._0;
                    return {ctor: "_Tuple2"
                           ,_0: A2(model,error,data)
                           ,_1: $MassiveDecks$API.toEffect(A2($Task.map,
                           function (_p8) {
                              return A2($MassiveDecks$Actions$Action.Choose,
                              _p9,
                              $MassiveDecks$Actions$Action.Result(_p8));
                           },
                           A3($MassiveDecks$API.choose,data.lobby.id,data.secret,_p9)))};
                 } else {
                    var _p10 = _p0._1._0;
                    return {ctor: "_Tuple2"
                           ,_0: A2(model,
                           error,
                           _U.update(data,
                           {lobby: _p10.lobby,hand: _p10.hand,picked: _U.list([])}))
                           ,_1: $Effects.none};
                 }
            default: break _v0_8;}
      } while (false);
      return {ctor: "_Tuple2"
             ...
             A2($Basics._op["++"],
             $Basics.toString(_p0),
             ") that can\'t be handled in the current state (Playing)."))),
             data)
             ,_1: $Effects.none};
   });
   return _elm.MassiveDecks.Playing.values = {_op: _op
                                             ,update: update
                                             ,model: model
                                             ,modelSub: modelSub
...
Elm.MassiveDecks = Elm.MassiveDecks || {};
Elm.MassiveDecks.Config = Elm.MassiveDecks.Config || {};
Elm.MassiveDecks.Config.make = function (_elm) {
   "use strict";
   _elm.MassiveDecks = _elm.MassiveDecks || {};
   _elm.MassiveDecks.Config = _elm.MassiveDecks.Config || {};
   if (_elm.MassiveDecks.Config.values)
   return _elm.MassiveDecks.Config.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $MassiveDecks$Models$Player = Elm.MassiveDecks.Models.Player.make(_elm),
   $MassiveDecks$Models$State = Elm.MassiveDecks.Models.State.make(_elm),
   $MassiveDecks$Playing = Elm.MassiveDecks.Playing.make(_elm),
   $MassiveDecks$UI$Config = Elm.MassiveDecks.UI.Config.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var view = F3(function (address,error,data) {
      return A3($MassiveDecks$UI$Config.view,address,data,error);
   });
   var initialData = F2(function (lobby,secret) {
      return {lobby: lobby,secret: secret,deckId: ""};
   });
   var modelSub = F4(function (error,lobbyId,secret,data) {
      return {state: $MassiveDecks$Models$State.SConfig(data)
             ,jsAction: $Maybe.Just({lobbyId: lobbyId,secret: secret})
   ...
   var update = F3(function (action,error,data) {
      ...
      _v0_7: do {
         switch (_p0.ctor)
         {case "UpdateInputValue": var _p1 = _p0._0;
              if (_p1 === "deckId") {
                    return {ctor: "_Tuple2"
                           ,_0: A2(model,error,_U.update(data,{deckId: _p0._1}))
                           ,_1: $Effects.none};
                 } else {
                    return {ctor: "_Tuple2"
                           ,_0: A2(model,
                           $Maybe.Just("Got an update for an unknown input."),
                           data)
                           ,_1: $Effects.none};
                 }
            case "AddDeck": if (_p0._0.ctor === "Request") {
                    return {ctor: "_Tuple2"
                           ,_0: A2(model,error,data)
                           ,_1: $MassiveDecks$API.toEffect(A2($Task.map,
                           function (_p2) {
                              return $MassiveDecks$Actions$Action.AddDeck($MassiveDecks$Actions$Action.Result(_p2));
                           },
                           A3($MassiveDecks$API.addDeck,
                           data.lobby.id,
                           data.secret,
                           data.deckId)))};
                 } else {
                    return {ctor: "_Tuple2"
                           ,_0: A2(model,error,_U.update(data,{lobby: _p0._0._0.lobby}))
                           ,_1: $Effects.none};
                 }
            case "StartGame": if (_p0._0.ctor === "Request") {
                    return {ctor: "_Tuple2"
                           ,_0: A2(model,error,data)
                           ,_1: $MassiveDecks$API.toEffect(A2($Task.map,
                           function (_p3) {
                              return $MassiveDecks$Actions$Action.StartGame($MassiveDecks$Actions$Action.Result(_p3));
                           },
                           A2($MassiveDecks$API.newGame,data.lobby.id,data.secret)))};
                 } else {
                    var _p4 = _p0._0._0;
                    return {ctor: "_Tuple2"
                           ,_0: A2($MassiveDecks$Playing.model,
                           error,
                           A4($MassiveDecks$Models$State.PlayingData,
                           _p4.lobby,
                           _p4.hand,
                           data.secret,
                           _U.list([])))
            ...
            case "Notification": var _p6 = _p0._0;
              var _p5 = _p6.round;
              if (_p5.ctor === "Just") {
                    return {ctor: "_Tuple2"
                           ,_0: A2(model,error,data)
                           ,_1: $MassiveDecks$API.toEffect(A2($Task.map,
                           function (lobbyAndHand) {
                              return A3($MassiveDecks$Actions$Action.JoinLobby,
                              _p6.id,
                              data.secret,
                              $MassiveDecks$Actions$Action.Result(lobbyAndHand));
                           },
                           A2($MassiveDecks$API.getLobbyAndHand,_p6.id,data.secret)))};
                 } else {
                    return {ctor: "_Tuple2"
                           ,_0: A2(model,error,_U.update(data,{lobby: _p6}))
                           ,_1: $Effects.none};
                 }
            case "JoinLobby": if (_p0._2.ctor === "Result") {
                    var _p8 = _p0._2._0;
                    var _p7 = _p8.lobby.round;
                    if (_p7.ctor === "Just") {
                          return {ctor: "_Tuple2"
                                 ,_0: A2($MassiveDecks$Playing.model,
                                 error,
                          ...
                          return {ctor: "_Tuple2"
                                 ,_0: A2(model,error,_U.update(data,{lobby: _p8.lobby}))
                                 ,_1: $Effects.none};
                       }
                 } else {
                    break _v0_7;
      ...
      return {ctor: "_Tuple2"
             ...
             A2($Basics._op["++"],
             $Basics.toString(_p0),
             ") that can\'t be handled in the current state (Config)."))),
             data)
             ,_1: $Effects.none};
   });
   return _elm.MassiveDecks.Config.values = {_op: _op
                                            ,update: update
                                            ,model: model
                                            ,modelSub: modelSub
...
Elm.MassiveDecks = Elm.MassiveDecks || {};
Elm.MassiveDecks.UI = Elm.MassiveDecks.UI || {};
Elm.MassiveDecks.UI.Start = Elm.MassiveDecks.UI.Start || {};
Elm.MassiveDecks.UI.Start.make = function (_elm) {
   "use strict";
   _elm.MassiveDecks = _elm.MassiveDecks || {};
   _elm.MassiveDecks.UI = _elm.MassiveDecks.UI || {};
   _elm.MassiveDecks.UI.Start = _elm.MassiveDecks.UI.Start || {};
   if (_elm.MassiveDecks.UI.Start.values)
   return _elm.MassiveDecks.UI.Start.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var newGame = function (address) {
      return A2($Html.button,
      _U.list([$Html$Attributes.$class("mui-btn mui-btn--large mui-btn--primary")
              ,A2($Html$Events.onClick,
              address,
              $MassiveDecks$Actions$Action.NewLobby($MassiveDecks$Actions$Action.Request))]),
      _U.list([$Html.text("Create Game")]));
   };
   var joinGame = function (address) {
      return A2($Html.button,
      _U.list([$Html$Attributes.$class("mui-btn mui-btn--large mui-btn--primary")
              ,A2($Html$Events.onClick,
              address,
              $MassiveDecks$Actions$Action.JoinExistingLobby)]),
      _U.list([$Html.text("Join Game")]));
   };
   var lobbyIdEntry = function (address) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("lobby-id-entry mui-textfield")]),
      _U.list([A2($Html.input,
              _U.list([$Html$Attributes.type$("text")
                      ,$Html$Attributes.placeholder("Game Code")
                      ,A3($Html$Events.on,
                      "change",
                      $Html$Events.targetValue,
                      function (name) {
              ...
              _U.list([]),
              _U.list([$MassiveDecks$UI$General.icon("info-circle")
                      ,$Html.text(" The code for the game to join.")]))]));
   };
   var nameEntry = function (address) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("nickname-entry mui-textfield")]),
      _U.list([A2($Html.input,
              _U.list([$Html$Attributes.type$("text")
                      ,$Html$Attributes.placeholder("Nickname")
                      ,A3($Html$Events.on,
                      "change",
                      $Html$Events.targetValue,
                      function (name) {
                         return A2($Signal.message,
                         address,
                         A2($MassiveDecks$Actions$Action.UpdateInputValue,"name",name));
                      })]),
              _U.list([]))
              ,A2($Html.label,
              _U.list([]),
              _U.list([$MassiveDecks$UI$General.icon("info-circle")
                      ,$Html.text(" Your name in the game.")]))]));
   };
   var view = F2(function (address,error) {
      return A2($Html.div,
      _U.list([$Html$Attributes.id("start-screen")]),
      $List.concat(_U.list([_U.list([A2($Html.div,
                           _U.list([$Html$Attributes.id("start-screen-content")
                                   ,$Html$Attributes.$class("mui-panel")]),
                           _U.list([A2($Html.h1,
                                   _U.list([]),
                                   _U.list([$Html.text("Massive Decks")]))
                                   ,nameEntry(address)
                                   ,A2($Html.ul,
                                   _U.list([$Html$Attributes.$class("mui-tabs__bar mui-tabs__bar--justified")]),
                                   _U.list([A2($Html.li,
                                           _U.list([$Html$Attributes.$class("mui--is-active")]),
                                           _U.list([A2($Html.a,
                                           _U.list([A2($Html$Attributes.attribute,"data-mui-toggle","tab")
                                   ...
                                   ,A2($Html.div,
                                   _U.list([$Html$Attributes.$class("mui-tabs__pane mui--is-active")
                                           ,$Html$Attributes.id("pane-new")]),
                                   _U.list([newGame(address)]))
                                   ,A2($Html.div,
                                   _U.list([$Html$Attributes.$class("mui-tabs__pane")
                                           ,$Html$Attributes.id("pane-existing")]),
                                   _U.list([lobbyIdEntry(address),joinGame(address)]))]))])
                           ,$MassiveDecks$UI$General.errorMessage(error)])));
   });
   return _elm.MassiveDecks.UI.Start.values = {_op: _op
                                              ,view: view
                                              ,nameEntry: nameEntry
                                              ,lobbyIdEntry: lobbyIdEntry
                                              ,joinGame: joinGame
                                              ,newGame: newGame};
};
Elm.MassiveDecks = Elm.MassiveDecks || {};
Elm.MassiveDecks.Start = Elm.MassiveDecks.Start || {};
Elm.MassiveDecks.Start.make = function (_elm) {
   "use strict";
   _elm.MassiveDecks = _elm.MassiveDecks || {};
   _elm.MassiveDecks.Start = _elm.MassiveDecks.Start || {};
   if (_elm.MassiveDecks.Start.values)
   return _elm.MassiveDecks.Start.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $MassiveDecks$API = Elm.MassiveDecks.API.make(_elm),
   $MassiveDecks$Actions$Action = Elm.MassiveDecks.Actions.Action.make(_elm),
   $MassiveDecks$Config = Elm.MassiveDecks.Config.make(_elm),
   $MassiveDecks$Models$State = Elm.MassiveDecks.Models.State.make(_elm),
   $MassiveDecks$Playing = Elm.MassiveDecks.Playing.make(_elm),
   $MassiveDecks$UI$Start = Elm.MassiveDecks.UI.Start.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var view = F3(function (address,error,data) {
      return A2($MassiveDecks$UI$Start.view,address,error);
   });
   var initialData = {name: "",lobbyId: ""};
   var model = F2(function (error,data) {
      return {state: $MassiveDecks$Models$State.SStart(data)
             ,jsAction: $Maybe.Nothing
             ,error: error};
   });
   var update = F3(function (action,error,data) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "UpdateInputValue": var _p2 = _p0._1;
           var _p1 = _p0._0;
           switch (_p1)
           {case "name": return {ctor: "_Tuple2"
                                ,_0: A2(model,error,_U.update(data,{name: _p2}))
                                ,_1: $Effects.none};
              case "lobbyId": return {ctor: "_Tuple2"
                                     ,_0: A2(model,error,_U.update(data,{lobbyId: _p2}))
                                     ,_1: $Effects.none};
              default: return {ctor: "_Tuple2"
                              ,_0: A2(model,
                              $Maybe.Just("Got an update for an unknown input."),
                              data)
                              ,_1: $Effects.none};}
         case "NewLobby": if (_p0._0.ctor === "Request") {
                 return {ctor: "_Tuple2"
                        ,_0: A2(model,error,data)
                        ,_1: $MassiveDecks$API.toEffect(A2($Task.map,
                        function (_p3) {
                           return $MassiveDecks$Actions$Action.NewLobby($MassiveDecks$Actions$Action.Result(_p3));
                        },
                        $MassiveDecks$API.createLobby))};
              } else {
                 var _p4 = _p0._0._0;
                 return {ctor: "_Tuple2"
                        ,_0: A2(model,error,data)
                        ...
                        A2($MassiveDecks$API.newPlayer,_p4.id,data.name)))};
              }
         case "JoinExistingLobby": return {ctor: "_Tuple2"
                                          ,_0: A2(model,error,data)
                                          ,_1: $MassiveDecks$API.toEffect(A2($Task.map,
                                          function (secret) {
                                             return A3($MassiveDecks$Actions$Action.JoinLobby,
                                          ...
                                          A2($MassiveDecks$API.newPlayer,data.lobbyId,data.name)))};
         case "JoinLobby": if (_p0._2.ctor === "Request") {
                 var _p6 = _p0._1;
                 var _p5 = _p0._0;
                 return {ctor: "_Tuple2"
                        ,_0: A2(model,error,data)
                        ...
                        A2($MassiveDecks$API.getLobbyAndHand,_p5,_p6)))};
              } else {
                 var _p10 = _p0._1;
                 var _p9 = _p0._0;
                 var _p8 = _p0._2._0;
                 ...
                 if (_p7.ctor === "Just") {
                       return {ctor: "_Tuple2"
                              ,_0: A4($MassiveDecks$Playing.modelSub,
                              error,
                              _p9,
                              _p10,
                              A4($MassiveDecks$Models$State.PlayingData,
                       ...
                       return {ctor: "_Tuple2"
                              ,_0: A4($MassiveDecks$Config.modelSub,
                              error,
                              _p9,
                              _p10,
                              A2($MassiveDecks$Config.initialData,_p8.lobby,_p10))
                              ,_1: $Effects.none};
                    }
              }
         default: return {ctor: "_Tuple2"
                         ...
                         A2($Basics._op["++"],
                         $Basics.toString(_p0),
                         ") that can\'t be handled in the current state (Start)."))),
                         data)
                         ,_1: $Effects.none};}
   });
   return _elm.MassiveDecks.Start.values = {_op: _op
                                           ,update: update
                                           ,model: model
                                           ,initialData: initialData
                                           ,view: view};
...
Elm.MassiveDecks = Elm.MassiveDecks || {};
Elm.MassiveDecks.Main = Elm.MassiveDecks.Main || {};
Elm.MassiveDecks.Main.make = function (_elm) {
   "use strict";
   _elm.MassiveDecks = _elm.MassiveDecks || {};
   _elm.MassiveDecks.Main = _elm.MassiveDecks.Main || {};
   if (_elm.MassiveDecks.Main.values)
   return _elm.MassiveDecks.Main.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $MassiveDecks$Models$State = Elm.MassiveDecks.Models.State.make(_elm),
   $MassiveDecks$Playing = Elm.MassiveDecks.Playing.make(_elm),
   $MassiveDecks$Start = Elm.MassiveDecks.Start.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   ...
   var view = F2(function (address,model) {
      var _p0 = model.state;
      switch (_p0.ctor)
      {case "SStart": return A3($MassiveDecks$Start.view,
           address,
           model.error,
           _p0._0);
         case "SConfig": return A3($MassiveDecks$Config.view,
           address,
           model.error,
           _p0._0);
         default: return A3($MassiveDecks$Playing.view,
           address,
           model.error,
           _p0._0);}
   });
   ...
   var update = F2(function (action,model) {
      var model = debug ? _U.update(model,
      {error: $Maybe.Just($Basics.toString(action))}) : model;
      var _p1 = action;
      switch (_p1.ctor)
      {case "NoAction": return {ctor: "_Tuple2"
                               ,_0: model
                               ,_1: $Effects.none};
         case "DisplayError": return {ctor: "_Tuple2"
                                     ,_0: _U.update(model,{error: $Maybe.Just(_p1._0)})
                                     ,_1: $Effects.none};
         default: var _p2 = model.state;
           switch (_p2.ctor)
           {case "SStart": return A3($MassiveDecks$Start.update,
                action,
                model.error,
                _p2._0);
              case "SConfig": return A3($MassiveDecks$Config.update,
                action,
                model.error,
                _p2._0);
              default: return A3($MassiveDecks$Playing.update,
                action,
                model.error,
                _p2._0);}}
   });
   var model = A2($MassiveDecks$Start.model,
   $Maybe.Nothing,
   $MassiveDecks$Start.initialData);
   var notifications = Elm.Native.Port.make(_elm).inboundSignal("notifications",
   "String",
   function (v) {
      return typeof v === "string" || typeof v === "object" && v instanceof String ? v : _U.badPort("a string",
      v);
   });
   var notificationDecoded = A2($Signal.map,
   function (result) {
      var _p3 = result;
      if (_p3.ctor === "Just") {
            return $MassiveDecks$Actions$Action.Notification(_p3._0);
         } else {
            return $MassiveDecks$Actions$Action.NoAction;
         }
   },
   A3($Signal.filterMap,
   function (_p4) {
      return $Maybe.Just($Result.toMaybe(_p4));
   },
   $Maybe.Nothing,
   A2($Signal.map,
   $Json$Decode.decodeString($MassiveDecks$Models$Json$Decode.lobbyDecoder),
   notifications)));
   var game = $StartApp.start({init: {ctor: "_Tuple2"
                                     ,_0: model
                                     ,_1: $Effects.none}
                              ,update: update
                              ,view: view
                              ,inputs: _U.list([notificationDecoded])});
   var tasks = Elm.Native.Task.make(_elm).performSignal("tasks",
   game.tasks);
   var jsAction = Elm.Native.Port.make(_elm).outboundSignal("jsAction",
   function (v) {
      return v.ctor === "Nothing" ? null : {lobbyId: v._0.lobbyId
   ...
   game.model));
   var main = game.html;
   return _elm.MassiveDecks.Main.values = {_op: _op
                                          ,game: game
                                          ,notificationDecoded: notificationDecoded
                                          ,main: main
                                          ,model: model
                                          ,debug: debug
                                          ,update: update
